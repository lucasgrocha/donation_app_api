...
FactoryBot.create(:comment, user: user_1, product: donation_2.donatable)
FactoryBot.create(:comment, user: user_1, product: donation_4.donatable)
FactoryBot.create(:comment, user: user_1, product: donation_5.donatable)
FactoryBot.create(:comment, user: user_2, product: donation_1.donatable)
FactoryBot.create(:comment, user: user_2, product: donation_3.donatable)
FactoryBot.create(:comment, user: user_2, product: donation_4.donatable)
FactoryBot.create(:comment, user: user_3, product: donation_2.donatable)
FactoryBot.create(:comment, user: user_3, product: donation_3.donatable)
FactoryBot.create(:comment, user: user_3, product: donation_5.donatable)
